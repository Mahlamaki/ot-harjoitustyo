...
**!EDIT! Alustavasta versiosta poistettu kirjautumismahdollisuus. Se on lisättynä jatkokehitysideoihin. Sovelluksessa olisi siis alustavasti vain 6 näkymää.**
...
Sovellus avautuu etusivulle, jossa on mahdollista valita **"Luo lappu"**, **"Muokkaa lappuja"**, **"Harjoittele"** ja  **"Poistu"**
...
## Jatkokehitysideoita
- Sovellukseen voi lisätä kirjautumisominaisuuden salasanoineen (tämä jouduttiin tästä ensimmäisestä versiosta karsimaan pois)
