...
class UI:
    ...
    def _show_new_card_view(self):
        ...
        self._current_view = NewCardView(self._root,self._go_home)
        self._current_view.pack()
    ...
    def _show_edit_view(self):
        ...
        self._current_view = EditCardView(self._root)   
        self._current_view.pack() 
    ...
    def _show_practise_view(self):
        ...
        self._current_view = PractiseView(self._root)  
        self._current_view.pack()  
...
class HomePageView:
    ...
    def _initialize(self):
        ...
        edit_cards_button = ttk.Button(master=self._frame, text="Muokkaa kortteja", command=None)
        practise_button = ttk.Button(master=self._frame, text="Kertaa", command=None)
...
class NewCardView:
    ...
    def _initialize(self):
        ...
        back_home_button = ttk.Button(master=self._frame, text="Lopeta", command=self._go_home)
        ...
        back_home_button.pack(side=constants.BOTTOM)
