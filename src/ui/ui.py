...
class UI:
    ...
    def _show_homepage_view(self):
        ...
        self._current_view = HomePageView(
            self._root, self._show_add_book, self._close)
...
class HomePageView:
    ...
    def _initialize(self):
        ...
        welcome_label = ttk.Label(
            master=self._frame, text="Tervetuloa kirjakerhomme kirjalogiin!", font=("Helvetica", 16, "bold"))
        menu_label = ttk.Label(
            master=self._frame, text="Mitä haluaisit tehdä seuraavaksi?", font=("Helvetica", 14))
        ...
        browse_books_button = ttk.Button(
            master=self._frame, text="Selaa login kirjoja")
...
class AddBook:
    ...
    def _initialize(self):
        self._frame = ttk.Frame(master=self._root)
        welcome_label = ttk.Label(
            master=self._frame, text="Täytä uuden kirjan tiedot", font=("Helvetica", 16, "bold"))
