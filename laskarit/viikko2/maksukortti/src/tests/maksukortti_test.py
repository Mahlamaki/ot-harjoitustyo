...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_ei_voida_ladata_negatiivista_arvoa(self):
    	self.kortti.lataa_rahaa(-100)
    	
    	self.assertEqual(self.kortti.saldo_euroina(), 10.0)
        
    def test_pystyy_ostamaan_edullisen_lounaan_kun_edullisen_verran_saldoa(self):
    	kortti = Maksukortti(250)
    	kortti.syo_edullisesti()
    	
    	self.assertEqual(kortti.saldo_euroina(), 0)
    	
    def test_pystyy_ostamaan_maukkaan_lounaan_kun_maukkaan_verran_saldoa(self):
